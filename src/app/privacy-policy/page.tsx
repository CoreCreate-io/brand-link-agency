...
export const metadata: Metadata = {
  title: 'Privacy Policy - Brand Link',
  description: 'View our Privacy Policy at Brand Link.',
}

export default async function PrivacyPolicyPage() {
  const pageData: PageData = await client.fetch(pageContentQuery, { slug: 'privacy-policy' })
